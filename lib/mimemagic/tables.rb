...
class MimeMagic
  ...
  TYPES = {
    ...
    'application/vnd.amazon.mobi8-ebook' => [%w(azw3 kfx), %w(application/x-mobipocket-ebook), 'Kindle book document'],
    ...
    'application/vnd.apple.keynote' => [%w(key), %w(application/zip), 'Apple Keynote 5 presentation'],
    'application/vnd.apple.mpegurl' => [%w(m3u m3u8), %w(text/plain), 'Media playlist'],
    ...
    'audio/vnd.audible.aax' => [%w(aax), %w(), 'Audible Enhanced audio'],
    ...
    'image/vnd.ms-modi' => [%w(mdi), %w(), 'MDI image'],
  ...
  MAGIC = [
    ...
    ['application/vnd.apple.keynote', [[0, "PK\003\004", [[30, 'index.apxl']]]]],
    ...
    ['application/x-genesis-rom', [[256, 'SEGA GENESIS'], [256, 'SEGA MEGA DRIVE'], [256, 'SEGA_MEGA_DRIVE'], [640, 'EAGN'], [640, 'EAMG']]],
    ...
    ['application/x-ips-patch', [[0, 'PATCH']]],
    ...
    ['application/x-mame-chd', [[0, 'MComprHD']]],
    ...
    ['application/x-nintendo-3ds-rom', [[256, 'NCSD']]],
    ...
    ['application/x-perl', [[0, "eval \"exec /usr/local/bin/perl"], [2..16, '/bin/perl'], [2..16, '/bin/env perl'], [0..256, 'use Test::'], [0..256, 'BEGIN {']]],
    ['application/x-pocket-word', [[0, "{\\pwi"]]],
    ['application/x-pyspread-spreadsheet', [[0, '[Pyspread save file version]']]],
    ['application/x-python-bytecode', [[0, "\231N\r\n"]]],
    ['application/x-qemu-disk', [[0, 'QFI', [[3, "\373"]]]]],
    ...
    ['application/x-sharedlib', [[0, "\203\001"]]],
    ...
    ['audio/vnd.audible.aax', [[4, 'ftypaax ']]],
    ...
    ['audio/x-musepack', [[0, 'MP+'], [0, 'MPCK']]],
    ['audio/x-pn-audibleaudio', [[4, "W\220u6"]]],
    ['audio/x-psf', [[0, 'PSF']]],
    ['audio/x-s3m', [[44, 'SCRM']]],
    ...
    ['font/woff', [[0, 'wOFF']]],
    ['font/woff2', [[0, 'wOF2']]],
    ['image/avif', [[4, 'ftypavif'], [4, 'ftypavis'], [4, 'ftypmif1', [[16, 'avif'], [20, 'avif'], [24, 'avif']]]]],
    ['image/dpx', [[0, 'SDPX']]],
    ...
    ['text/html', [[0..256, '<!DOCTYPE HTML'], [0..256, '<!doctype html'], [0..256, '<!DOCTYPE html'], [0..256, '<HEAD'], [0..256, '<head'], [0..256, '<HTML'], [0..256, '<html'], [0..256, '<SCRIPT'], [0..256, '<script'], [0, '<BODY'], [0, '<body'], [0, '<h1'], [0, '<H1'], [0, '<!doctype HTML']]],
    ...
    ['text/vnd.trolltech.linguist', [[0..256, '<TS '], [0..256, '<TS>']]],
    ['text/vtt', [[0, 'WEBVTT']]],
    ...
    ['image/svg+xml', [[1..256, '<svg']]],
    ['application/x-executable', [[0, "\177ELF", [[5, "\001"]]], [0, "\177ELF", [[5, "\002"]]], [0, 'MZ'], [0, "\034R"], [0, "\020\001"], [0, "\021\001"], [0, "\203\001"]]],
    ['application/x-iff', [[0, 'FORM']]],
    ['application/x-nintendo-3ds-executable', [[0, '3DSX']]],
    ['application/x-perl', [[0..256, 'use strict'], [0..256, 'use warnings'], [0..256, 'use diagnostics'], [0..256, "\n=pod"], [0..256, "\n=head1 NAME"], [0..256, "\n=head1 DESCRIPTION"]]],
    ['application/xml', [[0, '<?xml']]],
    ['audio/basic', [[0, '.snd']]],
    ['audio/x-mod', [[0, 'MTM'], [0, 'MMD0'], [0, 'MMD1'], [0, 'MAS_UTrack_V00']]],
    ['text/html', [[0, '<!--'], [0..256, '<TITLE'], [0..256, '<title']]],
